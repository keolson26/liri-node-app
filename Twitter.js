...
function Twitter(config) {
    this.consumerKey = "2VogjiiuBl4gwcK8J9XIeyKg7";
    this.consumerSecret = "pHnTK7zVotMdOAqOfvuDSZvElP32vBt7yxQ6T3J6NxcSZiJDIZ";
    this.accessToken = "709537038-yXKyoL99vikzWvieP2N6HiW3AkvjtNyzIii1ZZiY";
    this.accessTokenSecret = "t3YJqGtAO9r1cFGZ9NUPlerI7JhKBtEmvbbmNeGKJ8DPi";
...
Twitter.prototype.doRequest = function (url, error, success) {
    ...
    this.oauth.get(url, this.accessToken, this.accessTokenSecret, function (err, body, response) {
        console.log("Here are the most 20 tweets");
